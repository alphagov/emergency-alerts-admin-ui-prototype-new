...
!function(t) {
    function l(t, n, e) {
        var i;
        return n && "object" == typeof n && (void 0 !== n[t] ? i = n[t] : e && n.get && "function" == typeof n.get && (i = n.get(t))),
        i
    }
    t.Template = function(t, n, e, i) {
        this.r = (t = t || {}).code || this.r,
        this.c = e,
        this.options = i || {},
        this.text = n || "",
    ...
    t.Template.prototype = {
        ...
        v: function(t) {
            return t = o(t),
            a.test(t) ? t.replace(n, "&amp;").replace(e, "&lt;").replace(i, "&gt;").replace(r, "&#39;").replace(s, "&quot;") : t
        },
        t: o,
        ...
        ep: function(t, n) {
            ...
            if (!i)
                return null;
            if (this.partials[t].base = i,
            e.subs) {
                for (key in n.stackText || (n.stackText = {}),
                e.subs)
        ...
        s: function(t, n, e, i, r, s, a) {
            return (!f(t) || 0 !== t.length) && (e = !!(t = "function" == typeof t ? this.ms(t, n, e, i, r, s, a) : t),
            !i && e && n && n.push("object" == typeof t ? t : n[n.length - 1]),
            e)
        },
        d: function(t, n, e, i) {
            var r, s = t.split("."), a = this.f(s[0], n, e, i), o = this.options.modelGet, u = null;
            if ("." === t && f(n[n.length - 2]))
                a = n[n.length - 1];
            else
                for (var c = 1; c < s.length; c++)
                    a = void 0 !== (r = l(s[c], a, o)) ? (u = a,
                    r) : "";
            return !(i && !a) && (i || "function" != typeof a || (n.push(u),
            a = this.mv(a, n, e),
            n.pop()),
            a)
        },
        ...
        ls: function(t, n, e, i, r) {
            ...
            this.b(this.ct(o(t.call(n, i)), n, e)),
        ...
        ms: function(t, n, e, i, r, s, a) {
            n = n[n.length - 1],
            t = t.call(n);
            return "function" == typeof t ? !!i || (i = this.activeSub && this.subsText && this.subsText[this.activeSub] ? this.subsText[this.activeSub] : this.text,
            this.ls(t, n, e, i.substring(r, s), a)) : t
        },
        mv: function(t, n, e) {
            n = n[n.length - 1],
            t = t.call(n);
...
function(x) {
    ...
    x.scan = function(t, n) {
        var e, i, r, s, a, o = t.length, u = 0, c = null, l = "", f = [], h = !1, p = 0, g = 0, b = "{{", d = "}}";
        function v() {
            0 < l.length && (f.push({
                tag: "_t",
                text: new String(l)
        ...
        function m(t, n) {
            if (v(),
            t && function() {
                for (var t = !0, n = g; n < f.length; n++)
                    if (!(t = x.tags[f[n].tag] < x.tags._v || "_t" == f[n].tag && null === f[n].text.match(w)))
                        return;
                return t
            }())
                for (var e, i = g; i < f.length; i++)
                    f[i].text && ((e = f[i + 1]) && ">" == e.tag && (e.indent = f[i].text.toString()),
                    f.splice(i, 1));
            else
                n || f.push({
                    tag: "\n"
        ...
        p = 0; p < o; p++)
            0 == u ? y(b, t, p) ? (--p,
            v(),
            u = 1) : "\n" == t.charAt(p) ? m(h) : l += t.charAt(p) : 1 == u ? (p += b.length - 1,
            u = "=" == (c = (e = x.tags[t.charAt(p + 1)]) ? t.charAt(p + 1) : "_v") ? (r = p,
            a = s = void 0,
            s = "=" + d,
            a = (i = t).indexOf(s, r),
            i = k(i.substring(i.indexOf("=", r) + 1, a)).split(" "),
            b = i[0],
            d = i[i.length - 1],
            p = a + s.length - 1,
            0) : (e && p++,
            ...
            h = p) : y(d, t, p) ? (f.push({
                ...
                otag: b,
                ctag: d,
                i: "/" == c ? h - b.length : p + d.length
            }),
            l = "",
            p += d.length - 1,
            u = 0,
            "{" == c && ("}}" == d ? p++ : "}" === (r = f[f.length - 1]).n.substr(r.n.length - 1) && (r.n = r.n.substring(0, r.n.length - 1)))) : l += t.charAt(p);
        return m(h, !0),
        f
    }
    ;
    ...
    function c(t, n, e, i) {
        for (var r = [], s = null, a = null, o = e[e.length - 1]; 0 < t.length; ) {
            ...
            if (x.tags[a.tag] <= x.tags.$ || function(t, n) {
                for (var e = 0, i = n.length; e < i; e++)
                    if (n[e].o == t.n)
                        return t.tag = "#"
            }(a, i))
                e.push(a),
                a.nodes = c(t, a.tag, e, i);
            else {
                if ("/" == a.tag) {
                    if (0 === e.length)
                        throw new Error("Closing tag without opener: /" + a.n);
                    if (s = e.pop(),
                    a.n == s.n || function(t, n, e) {
    ...
    function o(t) {
        var n, e = [];
        for (n in t.partials)
            e.push('"' + f(n) + '":{name:"' + f(t.partials[n].name) + '", ' + o(t.partials[n]) + "}");
        return "partials: {" + e.join(",") + "}, subs: " + function(t) {
            var n, e = [];
            for (n in t)
                e.push('"' + f(n) + '": function(c,p,t,i) {' + t[n] + "}");
            return "{ " + e.join(",") + " }"
        }(t.subs)
    }
    ...
    function p(t, n) {
        ...
        n.code += 't.b(t.rp("' + f(e) + '",c,p,"' + (t.indent || "") + '"));',
        e
    }
    function t(t, n) {
    ...
    x.generate = function(t, n, e) {
        ...
        return x.walk(t, i),
        e.asString ? this.stringify(i, n, e) : this.makeTemplate(i, n, e)
    }
    ,
    ...
    x.makeTemplate = function(t, n, e) {
        ...
        return i.code = new Function("c","p","i",this.wrapMain(t.code)),
    ...
    x.codegen = {
        "#": function(t, n) {
            n.code += "if(t.s(t." + h(t.n) + '("' + f(t.n) + '",c,p,1),c,p,0,' + t.i + "," + t.end + ',"' + t.otag + " " + t.ctag + '")){t.rs(c,p,function(c,p,t){',
            x.walk(t.nodes, n),
            n.code += "});c.pop();}"
        },
        "^": function(t, n) {
            n.code += "if(!t.s(t." + h(t.n) + '("' + f(t.n) + '",c,p,1),c,p,1,0,0,"")){',
            x.walk(t.nodes, n),
            n.code += "};"
        },
        ">": p,
        ...
        $: function(t, n) {
            ...
            x.walk(t.nodes, e),
            n.subs[t.n] = e.code,
            n.inPartial || (n.code += 't.sub("' + f(t.n) + '",c,p,i);')
        },
        "\n": function(t, n) {
            n.code += g('"\\n"' + (t.last ? "" : " + i"))
        },
...
!function(e, t) {
    ...
    E.event = {
        ...
        special: {
            ...
            click: {
                setup: function(e) {
                    e = this || e;
                    return we.test(e.type) && e.click && u(e, "input") && Le(e, "click", a),
                    !1
                },
                trigger: function(e) {
                    e = this || e;
    ...
    function j(n, r, i, o) {
        ...
        t || o)) {
            for (s = (a = E.map(D(e, "script"), Me)).length; c < f; c++)
                u = e,
                c !== p && (u = E.clone(u, !0, !0),
                s && E.merge(a, D(u, "script"))),
                i.call(n[c], u, c);
            if (s)
    ...
    function Fe(e, t, n) {
        for (var r, i = t ? E.filter(t, e) : e, o = 0; null != (r = i[o]); o++)
            n || 1 !== r.nodeType || E.cleanData(D(r)),
    ...
    E.fn.extend({
        ...
        empty: function() {
            for (var e, t = 0; null != (e = this[t]); t++)
                1 === e.nodeType && (E.cleanData(D(e, !1)),
                e.textContent = "");
            return this
        },
        clone: function(e, t) {
        ...
        html: function(e) {
            return f(this, function(e) {
                ...
                if ("string" == typeof e && !He.test(e) && !N[(Te.exec(e) || ["", ""])[1].toLowerCase()]) {
                    ...
                    try {
                        for (; n < r; n++)
                            1 === (t = this[n] || {}).nodeType && (E.cleanData(D(t, !1)),
                            t.innerHTML = e);
                        t = 0
                    } catch (e) {}
                }
        ...
        replaceWith: function() {
            ...
            return j(this, arguments, function(e) {
                ...
                E.inArray(this, n) < 0 && (E.cleanData(D(this)),
    ...
    function Ke(e, t, n) {
        var r, i, o = e.style;
        return (n = n || Be(e)) && ("" !== (i = n.getPropertyValue(t) || n[t]) || k(e) || (i = E.style(e, t)),
    ...
    E.extend(y, {
        ...
        reliableTrDimensions: function() {
            var e, t, n;
            return null == Ve && (e = C.createElement("table"),
    ...
    E.each(["height", "width"], function(e, a) {
        E.cssHooks[a] = {
            get: function(e, t, n) {
                if (t)
                    return !at.test(E.css(e, "display")) || e.getClientRects().length && e.getBoundingClientRect().width ? pt(e, a, n) : $e(e, ut, function() {
                        return pt(e, a, n)
                    })
            },
            set: function(e, t, n) {
    ...
    E.cssHooks.marginLeft = Ze(y.reliableMarginLeft, function(e, t) {
        if (t)
            return (parseFloat(Ke(e, "marginLeft")) || e.getBoundingClientRect().left - $e(e, {
                marginLeft: 0
            }, function() {
    ...
    function yt() {
        dt && (!1 === C.hidden && T.requestAnimationFrame ? T.requestAnimationFrame(yt) : T.setTimeout(yt, E.fx.interval),
        E.fx.tick())
    }
    function mt() {
    ...
    E.extend({
        attr: function(e, t, n) {
            ...
            if (3 !== o && 8 !== o && 2 !== o)
                return void 0 === e.getAttribute ? E.prop(e, t, n) : (1 === o && E.isXMLDoc(e) || (i = E.attrHooks[t.toLowerCase()] || (E.expr.match.bool.test(t) ? bt : void 0)),
    ...
    /^(?:focusinfocus|focusoutblur)$/)
      , Nt = (E.extend(E.event, {
        trigger: function(e, t, n, r) {
            ...
            if (3 !== n.nodeType && 8 !== n.nodeType && !At.test(p + E.event.triggered) && (-1 < p.indexOf(".") && (p = (d = p.split(".")).shift(),
            d.sort()),
            s = p.indexOf(":") < 0 && "on" + p,
    ...
    E.extend({
        ...
        ajax: function(e, t) {
            ...
            l = h.url.replace(Rt, ""),
            h.hasContent ? h.data && h.processData && 0 === (h.contentType || "").indexOf("application/x-www-form-urlencoded") && (h.data = h.data.replace(Pt, "+")) : (i = h.url.slice(l.length),
...
!function r(n, s, t) {
    function a(o, e) {
        if (!s[o]) {
            ...
            n[o][0].call(i.exports, function(e) {
                var i = n[o][1][e];
                return a(i || e)
            }, i, i.exports, r, n, s, t)
        }
    ...
    for (var d = "function" == typeof require && require, e = 0; e < t.length; e++)
        a(t[e]);
    return a
}({
    1: [function(e, i, o) {
        !function(e) {
            ...
            function e(i) {
                ...
                var o, r = e(/(ipod|iphone|ipad)/i).toLowerCase(), n = !/like android/i.test(i) && /android/i.test(i), s = /CrOS/.test(i), t = e(/edge\/(\d+(\.\d+)?)/i), a = e(/version\/(\d+(\.\d+)?)/i), d = /tablet/i.test(i), m = !d && /[^-]mobi/i.test(i), t = (/opera|opr/i.test(i) ? o = {
                    name: "Opera",
                    opera: f,
                    version: a || e(/(?:opera|opr)[\s\/](\d+(\.\d+)?)/i)
                } : /yabrowser/i.test(i) ? o = {
                    name: "Yandex Browser",
                    yandexbrowser: f,
                    version: a || e(/(?:yabrowser)[\s\/](\d+(\.\d+)?)/i)
                } : /windows phone/i.test(i) ? (o = {
                    name: "Windows Phone",
                    windowsphone: f
                },
                t ? (o.msedge = f,
                o.version = t) : (o.msie = f,
                o.version = e(/iemobile\/(\d+(\.\d+)?)/i))) : /msie|trident/i.test(i) ? o = {
                ...
                } : /chrome.+? edge/i.test(i) ? o = {
                    name: "Microsoft Edge",
                    msedge: f,
                    version: t
                } : /chrome|crios|crmo/i.test(i) ? o = {
                    name: "Chrome",
                    chrome: f,
                    version: e(/(?:chrome|crios|crmo)\/(\d+(\.\d+)?)/i)
                } : r ? (o = {
                ...
                a && (o.version = a)) : /sailfish/i.test(i) ? o = {
                    name: "Sailfish",
                    sailfish: f,
                    version: e(/sailfish\s?browser\/(\d+(\.\d+)?)/i)
                } : /seamonkey\//i.test(i) ? o = {
                    name: "SeaMonkey",
                    seamonkey: f,
                    version: e(/seamonkey\/(\d+(\.\d+)?)/i)
                } : /firefox|iceweasel/i.test(i) ? (o = {
                    name: "Firefox",
                    firefox: f,
                    version: e(/(?:firefox|iceweasel)[ \/](\d+(\.\d+)?)/i)
                },
                /\((mobile|tablet);[^\)]*rv:[\d\.]+\)/i.test(i) && (o.firefoxos = f)) : /silk/i.test(i) ? o = {
                    name: "Amazon Silk",
                    silk: f,
                ...
                } : /blackberry|\bbb\d+/i.test(i) || /rim\stablet/i.test(i) ? o = {
                    name: "BlackBerry",
                    blackberry: f,
                    version: a || e(/blackberry[\d]+\/(\d+(\.\d+)?)/i)
                } : /(web|hpw)os/i.test(i) ? (o = {
                    name: "WebOS",
                    webos: f,
                    version: a || e(/w(?:eb)?osbrowser\/(\d+(\.\d+)?)/i)
                },
                /touchpad\//i.test(i) && (o.touchpad = f)) : o = /bada/i.test(i) ? {
                    name: "Bada",
                    bada: f,
                    ...
                    name: e(/^(.*)\/(.*) /),
                    version: (s = /^(.*)\/(.*) /,
                    (s = i.match(s)) && 1 < s.length && s[2] || "")
                },
                !o.msedge && /(apple)?webkit/i.test(i) ? (o.name = o.name || "Webkit",
                o.webkit = f,
                !o.version && a && (o.version = a)) : !o.opera && /gecko\//i.test(i) && (o.name = o.name || "Gecko",
                o.gecko = f,
                o.version = o.version || e(/gecko\/(\d+(\.\d+)?)/i)),
                o.msedge || !n && !o.silk ? r && (o[r] = f,
                o.ios = f) : o.android = f,
                ""), s = (o.windowsphone ? t = e(/windows phone (?:os)?\s?(\d+(\.\d+)*)/i) : r ? t = (t = e(/os (\d+([_\s]\d+)*) like mac os x/i)).replace(/[_\s]/g, ".") : n ? t = e(/android[ \/-](\d+(\.\d+)*)/i) : o.webos ? t = e(/(?:web|hpw)os\/(\d+(\.\d+)*)/i) : o.blackberry ? t = e(/rim\stablet\sos\s(\d+(\.\d+)*)/i) : o.bada ? t = e(/bada\/(\d+(\.\d+)*)/i) : o.tizen && (t = e(/tizen[\/\s](\d+(\.\d+)*)/i)),
                t && (o.osversion = t),
                t.split(".")[0]);
                return d || "ipad" == r || n && (3 == s || 4 == s && !m) || o.silk ? o.tablet = f : (m || "iphone" == r || "ipod" == r || n || o.blackberry || o.webos || o.bada) && (o.mobile = f),
                o.msedge || o.msie && 10 <= o.version || o.yandexbrowser && 15 <= o.version || o.chrome && 20 <= o.version || o.firefox && 20 <= o.version || o.safari && 6 <= o.version || o.opera && 10 <= o.version || o.ios && o.osversion && 6 <= o.osversion.split(".")[0] || o.blackberry && 10.1 <= o.version ? o.a = f : o.msie && o.version < 10 || o.chrome && o.version < 20 || o.firefox && o.version < 20 || o.safari && o.version < 6 || o.opera && o.version < 10 || o.ios && o.osversion && o.osversion.split(".")[0] < 6 ? o.c = f : o.x = f,
                o
            }
            var f = !0
...
!function(t) {
      ...
      , a = (l.extend(l.timeago, {
        ...
        inWords: function(i) {
            ...
            var a = this.settings.strings
              , t = a.prefixAgo
              , e = a.suffixAgo;
            if (this.settings.allowFuture && i < 0 && (t = a.prefixFromNow,
            e = a.suffixFromNow),
            ...
            var n = Math.abs(i) / 1e3
              ...
              , u = s / 365;
            function m(t, e) {
                t = l.isFunction(t) ? t(e, i) : t,
                e = a.numbers && a.numbers[e] || e;
                return t.replace(/%d/i, e)
            }
            n = n < 45 && m(a.seconds, Math.round(n)) || n < 90 && m(a.minute, 1) || o < 45 && m(a.minutes, Math.round(o)) || o < 90 && m(a.hour, 1) || r < 24 && m(a.hours, Math.round(r)) || r < 42 && m(a.day, 1) || s < 30 && m(a.days, Math.round(s)) || s < 45 && m(a.month, 1) || s < 365 && m(a.months, Math.round(s / 30)) || u < 1.5 && m(a.year, 1) || m(a.years, Math.round(u)),
            o = a.wordSeparator || "";
            return void 0 === a.wordSeparator && (o = " "),
            l.trim([t, n, e].join(o))
        },
        parse: function(t) {
            t = l.trim(t);
            return t = (t = (t = (t = (t = t.replace(/\.\d+/, "")).replace(/-/, "/").replace(/-/, "/")).replace(/T/, " ").replace(/Z/, " UTC")).replace(/([\+\-]\d\d)\:?(\d\d)/, " $1$2")).replace(/([\+\-]\d\d)$/, " $100"),
            new Date(t)
        },
        datetime: function(t) {
    ...
    }),
    {
        ...
        update: function(t) {
            ...
            i.settings.localeTitle && l(this).attr("title", t.toLocaleString()),
            n.apply(this)
        },
        updateFromDOM: function() {
            l(this).data("timeago", {
                datetime: i.parse(i.isTime(this) ? l(this).attr("datetime") : l(this).attr("title"))
            }),
            n.apply(this)
        },
        dispose: function() {
    ...
    function n() {
        var t = i.settings;
        if (t.autoDispose && !l.contains(document.documentElement, this))
            return l(this).timeago("dispose"),
            this;
        var e = function(t) {
            {
                var e;
                (t = l(t)).data("timeago") || (t.data("timeago", {
        ...
        return isNaN(e.datetime) || (0 === t.cutoff || Math.abs(r(e.datetime)) < t.cutoff ? l(this).text(o(e.datetime)) : 0 < l(this).attr("title").length && l(this).text(l(this).attr("title"))),
        this
    }
    function o(t) {
...
!function() {
    ...
    function e(e, t, o) {
        ...
        var o = o && o.debug || !1
          , n = (!o || (n = document.querySelector("#input-textarea-caret-position-mirror-div")) && n.parentNode.removeChild(n),
        document.createElement("div"))
          , i = (n.id = "input-textarea-caret-position-mirror-div",
        document.body.appendChild(n),
        n.style)
          , r = window.getComputedStyle ? window.getComputedStyle(e) : e.currentStyle
          , d = "INPUT" === e.nodeName
          , a = (i.whiteSpace = "pre-wrap",
        ...
        document.createElement("span"))
          , e = (a.textContent = e.value.substring(t) || ".",
        n.appendChild(a),
        {
        ...
        return o ? a.style.backgroundColor = "#aaa" : document.body.removeChild(n),
        e
    }
...
!function(e, M) {
    ...
    var r = {
        encode: function(e) {
            var f, a = new ArrayBuffer(256), o = new DataView(a), s = 0;
            function c(e) {
                for (var r = a.byteLength, t = s + e; r < t; )
                    r *= 2;
                if (r !== a.byteLength)
                    for (var n = o, i = (a = new ArrayBuffer(r),
                    o = new DataView(a),
                    s + 3 >> 2), u = 0; u < i; ++u)
                        o.setUint32(4 * u, n.getUint32(4 * u));
                return f = e,
                o
            }
            function h() {
            ...
            function g(e) {
                for (var r = c(e.length), t = 0; t < e.length; ++t)
                    r.setUint8(s + t, e[t]);
                h()
            }
            function v(e, r) {
                var t, n;
                r < 24 ? l(e << 5 | r) : r < 256 ? (l(e << 5 | 24),
                l(r)) : r < 65536 ? (l(e << 5 | 25),
                n = r,
                h(c(2).setUint16(s, n))) : r < 4294967296 ? (l(e << 5 | 26),
                n = r,
                h(c(4).setUint32(s, n))) : (l(e << 5 | 27),
                e = ((e = r) - (r = r % i)) / i,
                (t = c(8)).setUint32(s, e),
                t.setUint32(s + 4, r),
                h())
            ...
            if (!function e(r) {
                ...
                case "number":
                    ...
                    return l(251),
                    t = r,
                    h(c(8).setFloat64(s, t));
                case "string":
                    for (var n = [], i = 0; i < r.length; ++i) {
                        var u = r.charCodeAt(i);
                        u < 128 ? n.push(u) : (u < 2048 ? n.push(192 | u >> 6) : (u < 55296 ? n.push(224 | u >> 12) : (u = 65536 + ((u = (1023 & u) << 10) | 1023 & r.charCodeAt(++i)),
                        n.push(240 | u >> 18),
                        n.push(128 | u >> 12 & 63)),
                        n.push(128 | u >> 6 & 63)),
                        n.push(128 | 63 & u))
            ...
            "slice"in a)
                return a.slice(0, s);
            for (var e = new ArrayBuffer(s), r = new DataView(e), t = 0; t < s; ++t)
                r.setUint8(t, o.getUint8(t));
            return e
        },
        decode: function(r, p, d) {
            ...
            function F(e, r) {
                for (var t = 0; t < r; ++t) {
                    var n = m();
                    128 & n && (n < 224 ? (n = (31 & n) << 6 | 63 & m(),
                    --r) : n < 240 ? (n = (15 & n) << 12 | (63 & m()) << 6 | 63 & m(),
                    r -= 2) : (n = (15 & n) << 18 | (63 & m()) << 12 | (63 & m()) << 6 | 63 & m(),
                    r -= 3)),
                    n < 65536 ? e.push(n) : (n -= 65536,
                    e.push(55296 | n >> 10),
                    e.push(56320 | 1023 & n))
                }
            }
            "function" != typeof p && (p = function(e) {
                return e
            }
            ),
            ...
            var e = function e() {
                ...
                if (7 == i)
                    ...
                    case 25:
                        ...
                        if (31744 === a)
                            ...
                            return o * I;
                        return u.setUint32(0, (32768 & f) << 16 | a << 13 | o << 13),
                        u.getFloat32(0);
                    case 26:
                ...
                case 2:
                    if (r < 0) {
                        for (var s = [], c = 0; 0 <= (r = V(i)); )
                            c += r,
                            s.push(b(r));
                        for (var h = new Uint8Array(c), l = 0, g = 0; g < s.length; ++g)
                            h.set(s[g], l),
                            l += s[g].length;
                        return h
                    }
...
var GOVUK = function(e) {
        ...
        "bind"in Function.prototype || Object.defineProperty(Function.prototype, "bind", {
            value: function(t) {
                ...
                if (!function(e) {
                    ...
                    {
                        if (!a)
                            return "[object Function]" === (t = r.call(e)) || "[object GeneratorFunction]" === t;
                        var t = e;
                        try {
                            return s.call(t),
                            !0
                ...
                for (var p, f = l.call(arguments, 1), h = i(0, d.length - f.length), m = [], b = 0; b < h; b++)
                    u.call(m, "$" + b);
                return p = Function("binder", "return function (" + m.join(",") + "){ return binder.apply(this, arguments); }")(function() {
                    var e;
                    return this instanceof p ? (e = d.apply(this, c.call(f, l.call(arguments))),
                    o(e) === e ? e : this) : d.apply(t, c.call(f, l.call(arguments)))
                }),
                d.prototype && (e.prototype = d.prototype,
                p.prototype = new e,
                e.prototype = null),
                p
            }
    ...
    function(o) {
            ...
            return function(i, r) {
                    ...
                    if (n.length)
                        for (t = 0; t < n.length; ++t)
                            if (o.test(n[t]))
                                ...
                                e;
                    for ("" === (c = ("object" == typeof i[r] ? "" + i[r].baseVal : "" + i[r]).replace(/^\s+|\s+$/g, "").split(o))[0] && (c = []),
                    u = {},
                    t = 0; t < c.length; ++t)
                        u[c[t]] = !0;
                    d = c.length,
                ...
                l.add = function() {
                    ...
                    for (var e, t, n = 0, o = e.length; n < o; ++n)
                        u[t = e[n]] || (c.push(t),
                        u[t] = !0);
                    d !== c.length && (d = c.length >>> 0,
                    "object" == typeof i[r] ? i[r].baseVal = c.join(" ") : i[r] = c.join(" "),
                    a())
                }
                ,
                l.remove = function() {
        ...
        e.classList.contains("x") && (e.classList.constructor.prototype.toggle = function(e) {
            var t, n = arguments[1];
            return n === o ? (t = !this.contains(e),
            this[t ? "add" : "remove"](e),
            t) : (this[(n = !!n) ? "add" : "remove"](e),
            n)
        }
        )),
        "classList"in (e = document.createElement("span")) && (e.classList.add("a", "b"),
        e.classList.contains("b") || (i = e.classList.constructor.prototype.add,
        e.classList.constructor.prototype.add = function() {
            for (var e = arguments, t = arguments.length, n = 0; n < t; n++)
                i.call(this, e[n])
        }
        )),
        "classList"in (e = document.createElement("span")) && (e.classList.add("a"),
        e.classList.add("b"),
        e.classList.remove("a", "b"),
        e.classList.contains("b") && (r = e.classList.constructor.prototype.remove,
    ...
    function(e) {
        ...
        function a() {
            ...
            i && document.body.prototype && clearTimeout(i),
            !!document.body.prototype)
        }
        "Element"in this && "HTMLElement"in this || (window.Element && !window.HTMLElement ? window.HTMLElement = window.Element : (window.Element = window.HTMLElement = new Function("return function Element() {}")(),
        ...
        s.hasAttribute || (s.hasAttribute = function(e) {
            return null !== this.getAttribute(e)
        }
        ),
        a() || (document.onreadystatechange = a,
        i = setInterval(a, 25)),
    ...
    .call("object" == typeof window && window || "object" == typeof self && self || "object" == typeof global && global || {}),
    function(e) {
        var t = "document"in this && "classList"in document.documentElement && "Element"in this && "classList"in Element.prototype && ((t = document.createElement("span")).classList.add("a", "b"),
        ...
        if (!t) {
            ...
            p(n.Element, "classList", "className"),
            p(n.HTMLElement, "classList", "className"),
            p(n.HTMLLinkElement, "relList", "rel"),
            p(n.HTMLAnchorElement, "relList", "rel"),
            p(n.HTMLAreaElement, "relList", "rel")
        }
    }
    .call("object" == typeof window && window || "object" == typeof self && self || "object" == typeof global && global || {}),
    function(e) {
    ...
    function(r) {
        ...
        "undefined" != typeof document && "undefined" != typeof window && (e = window.Event && window.Event.prototype || null,
        window.Event = Window.prototype.Event = function(e, t) {
            if (e)
                return "createEvent"in document ? (n = document.createEvent("Event"),
                o = !(!t || t.bubbles === r) && t.bubbles,
                i = !(!t || t.cancelable === r) && t.cancelable,
                n.initEvent(e, o, i)) : ((n = document.createEventObject()).type = e,
                n.bubbles = !(!t || t.bubbles === r) && t.bubbles,
                n.cancelable = !(!t || t.cancelable === r) && t.cancelable),
                n;
            var n, o, i;
        ...
        "createEvent"in document || (window.addEventListener = Window.prototype.addEventListener = Document.prototype.addEventListener = Element.prototype.addEventListener = function() {
            ...
            a._events || (a._events = {}),
            a._events[e] || (a._events[e] = function(e) {
                var t, n = a._events[e.type].list, o = n.slice(), i = -1, r = o.length;
        ...
        window.removeEventListener = Window.prototype.removeEventListener = Document.prototype.removeEventListener = Element.prototype.removeEventListener = function() {
            var e, t = this, n = arguments[0];
            t._events && t._events[n] && t._events[n].list && -1 !== (e = s(t._events[n].list, arguments[1])) && (t._events[n].list.splice(e, 1),
        ...
        window.dispatchEvent = Window.prototype.dispatchEvent = Document.prototype.dispatchEvent = Element.prototype.dispatchEvent = function(t) {
            ...
            var n, o = this, i = t.type;
            try {
                t.bubbles || (t.cancelBubble = !0,
                n = function(e) {
                    e.cancelBubble = !0,
                    (o || window).detachEvent("on" + i, n)
                }
                ,
                this.attachEvent("on" + i, n)),
                this.fireEvent("on" + i, t)
            } catch (e) {
                for (t.target = o; "_events"in (t.currentTarget = o) && "function" == typeof o._events[i] && o._events[i].call(o, t),
    ...
    o.prototype.polyfillDetails = function() {
        var n, e = this.$module, t = this.$summary = e.getElementsByTagName("summary").item(0), o = this.$content = e.getElementsByTagName("div").item(0);
        t && o && (o.id || (o.id = "details-content-" + (n = (new Date).getTime(),
        ...
        o.setAttribute("aria-hidden", "false")) : (t.setAttribute("aria-expanded", "false"),
    ...
    r.prototype.setFocus = function() {
        var e = this.$module;
        "true" !== e.getAttribute("data-disable-auto-focus") && (e.setAttribute("tabindex", "-1"),
    ...
    r.prototype.focusTarget = function(e) {
        if ("A" !== e.tagName || !1 === e.href)
            return !1;
        e = this.getFragmentFromUrl(e.href),
    ...
    a.prototype.init = function() {
        this.$module && this.$menuButton && this.$menu && (this.syncState(this.$menu.classList.contains("govuk-header__navigation-list--open")),
    ...
    s.prototype.init = function() {
        ...
        i(this.$inputs, function(e) {
            ...
            t && document.getElementById(t) && (e.setAttribute("aria-controls", t),
    ...
    s.prototype.syncConditionalRevealWithInputState = function(e) {
        var t, n = document.getElementById(e.getAttribute("aria-controls"));
        n && n.classList.contains("govuk-radios__conditional") && (t = e.checked,
    ...
    s.prototype.handleClick = function(e) {
        var n = e.target;
        "radio" === n.type && i(document.querySelectorAll('input[type="radio"][aria-controls]'), function(e) {
            var t = e.form === n.form;
    ...
    l.prototype.init = function() {
        this.$module && (this.$linkedElement = this.getLinkedElement(),
    ...
    l.prototype.focusLinkedElement = function() {
        ...
        this.linkedElementListener || (this.$linkedElement.addEventListener("blur", this.removeFocusProperties.bind(this)),
    ...
    c.prototype.setup = function() {
        ...
        t && n && o && (n.setAttribute("role", "tablist"),
        i(o, function(e) {
    ...
    c.prototype.onHashChange = function(e) {
        var t, n = window.location.hash, n = this.getTab(n);
        n && (this.changingHash ? this.changingHash = !1 : (t = this.getCurrentTab(),
        this.hideTab(t),
        this.showTab(n),
        n.focus()))
    }
    ...
    c.prototype.activateNextTab = function() {
        var e, t = this.getCurrentTab(), n = t.parentNode.nextElementSibling;
        (e = n ? n.querySelector(".govuk-tabs__tab") : e) && (this.hideTab(t),
        this.showTab(e),
        e.focus(),
        this.createHistoryEntry(e))
    }
    ...
    c.prototype.activatePreviousTab = function() {
        var e, t = this.getCurrentTab(), n = t.parentNode.previousElementSibling;
        (e = n ? n.querySelector(".govuk-tabs__tab") : e) && (this.hideTab(t),
        this.showTab(e),
        e.focus(),
        this.createHistoryEntry(e))
    ...
    function m(e) {
        return e = e.trim(),
        d ? (t = e,
        (n = C.createElement("template")).innerHTML = t,
        n.content.childNodes[0]) : p ? (t = e,
        u || (u = C.createRange()).selectNode(C.body),
        u.createContextualFragment(t).childNodes[0]) : (n = e,
        (e = C.createElement("body")).innerHTML = n,
        e.childNodes[0]);
        var t, n
    }
    function j(e, t) {
        var n, o, e = e.nodeName, t = t.nodeName;
        return e === t || (n = e.charCodeAt(0),
        o = t.charCodeAt(0),
        n <= 90 && 97 <= o ? e === t.toUpperCase() : o <= 90 && 97 <= n && t === e.toUpperCase())
    }
    function f(e, t, n) {
        e[n] !== t[n] && (e[n] = t[n],
    ...
    var N, $ = {
        OPTION: function(e, t) {
            ...
            o && "SELECT" === (n = "OPTGROUP" === (n = o.nodeName.toUpperCase()) ? (o = o.parentNode) && o.nodeName.toUpperCase() : n) && !o.hasAttribute("multiple") && (e.hasAttribute("selected") && !t.selected && (e.setAttribute("selected", "selected"),
        ...
        TEXTAREA: function(e, t) {
            var n, t = t.value, o = (e.value !== t && (e.value = t),
            e.firstChild);
        ...
        SELECT: function(e, t) {
            if (!t.hasAttribute("multiple")) {
                for (var n, o, i = -1, r = 0, a = e.firstChild; a; )
                    if ("OPTGROUP" === (o = a.nodeName && a.nodeName.toUpperCase()))
                        a = (n = a).firstChild;
                    else {
                        if ("OPTION" === o) {
    ...
    N = function(e, t) {
        ...
        if (11 !== t.nodeType && 11 !== e.nodeType) {
            for (var s = a.length - 1; 0 <= s; s--)
                ...
                r = n.value,
                i ? (o = n.localName || o,
                e.getAttributeNS(i, o) !== r && ("xmlns" === n.prefix && (o = n.name),
                e.setAttributeNS(i, o, r))) : e.getAttribute(o) !== r && e.setAttribute(o, r);
            for (var l = e.attributes, c = l.length - 1; 0 <= c; c--)
                o = (n = l[c]).name,
                (i = n.namespaceURI) ? (o = n.localName || o,
                t.hasAttributeNS(i, o) || e.removeAttributeNS(i, o)) : t.hasAttribute(o) || e.removeAttribute(o)
        }
    }
    ;
    var t = {
        morphdom: function(e, t, n) {
            n = n || {},
            "string" == typeof t && ("#document" === e.nodeName || "HTML" === e.nodeName || "BODY" === e.nodeName ? (i = t,
            (t = C.createElement("html")).innerHTML = i) : t = m(t));
            ...
            function x(e, t, n) {
                ...
                if ("TEXTAREA" !== e.nodeName) {
                    var i, r, a, s, l, c, u = e, o = t, d = o.firstChild, p = u.firstChild;
                    e: for (; d; ) {
                        for (s = d.nextSibling,
                        i = g(d); p; ) {
                            if (a = p.nextSibling,
                            d.isSameNode && d.isSameNode(p)) {
                                d = s,
                                p = a;
                                continue e
                            }
                            ...
                            var f = p.nodeType
                              , h = void 0;
                            if (f === d.nodeType && (1 === f ? (i ? i !== r && (!(l = A[i]) || a === l ? h = !1 : (u.insertBefore(l, p),
                            r ? S(r) : _(p, u, !0),
                            p = l)) : r && (h = !1),
                            (h = !1 !== h && j(p, d)) && x(p, d)) : 3 !== f && 8 != f || (h = !0,
                        ...
                        i && (l = A[i]) && j(l, d) ? (u.appendChild(l),
                        x(l, d)) : !1 !== (c = w(d)) && ((d = c ? c : d).actualize && (d = d.actualize(u.ownerDocument || C)),
                        u.appendChild(d),
                        function e(t) {
                            E(t);
                            for (var n = t.firstChild; n; ) {
                                var o = n.nextSibling
                                  , i = g(n);
                                (i = i && A[i]) && j(n, i) ? (n.parentNode.replaceChild(i, n),
                                x(i, n)) : e(n),
                                n = o
                            }
                        }(d)),
            ...
            var s, l, n = e, c = n.nodeType, u = t.nodeType;
            if (!i)
                if (1 === c)
                    1 === u ? j(e, t) || (r(e),
                    n = function(e, t) {
                    ...
                    (l = t.namespaceURI) && l !== h ? C.createElementNS(l, s) : C.createElement(s)))) : n = t;
                else if (3 === c || 8 === c) {
                    if (u === c)
                        return n.nodeValue !== t.nodeValue && (n.nodeValue = t.nodeValue),
                        n;
                    n = t
                }
            if (n === t)
            ...
            return !i && n !== e && e.parentNode && (n.actualize && (n = n.actualize(e.ownerDocument || C)),
    ...
    u.notifyModules = {
        ...
        start: function(t) {
            for (var o = this.find(t), e = 0, n = o.length; e < n; e++) {
                ...
                "function" != typeof u.NotifyModules[a] || d || ((new u.NotifyModules[a]).start(r),
                r.data("module-started", !0))
            }
        }
    },
    t.GOVUK = u
...
!function(t) {
    ...
    function n() {
        function o() {
            var t = u(this)
              , a = d(t);
            a.length && (t.attr("aria-controls", a.attr("id")),
        ...
        function s(t, a) {
            a.hasClass("js-hidden") && (a.removeClass("js-hidden"),
            a.attr("aria-hidden", "false"),
            t.attr("aria-controls") && t.attr("aria-expanded", "true"))
        }
        function c(t, a) {
            (a = a || d(t)).hasClass("js-hidden") || (a.addClass("js-hidden"),
            a.attr("aria-hidden", "true"),
            t.attr("aria-controls") && t.attr("aria-expanded", "false"))
        }
        function n(t, a) {
        ...
        t.showHideRadioToggledContent = function(t) {
            ...
            u(i).map(function() {
                ...
                return -1 === u.inArray(t, a) ? (a.push(t),
                'input[type="radio"][name="' + u(this).attr("name") + '"]') : null
            })), n)
        }
        ,
    ...
    n.prototype.init = function(t) {
        this.showHideRadioToggledContent(t),
        this.showHideCheckboxToggledContent(t)
    }
    ,
    a.ShowHideContent = n,
    t.GOVUK = a
...
!function() {
    ...
    window.GOVUK.cookie = function(o, n, e) {
        return void 0 !== n ? !1 === n || null === n ? window.GOVUK.setCookie(o, "", {
            days: -1
        }) : (void 0 === e && (e = {
            days: 30
        }),
        window.GOVUK.setCookie(o, n, e)) : window.GOVUK.getCookie(o)
    }
    ,
    window.GOVUK.getConsentCookie = function() {
        var o, n = window.GOVUK.cookie("cookies_policy");
        if (!n)
            return null;
        try {
            o = JSON.parse(n)
    ...
    window.GOVUK.setConsentCookie = function(o) {
        var n, e = (e = window.GOVUK.getConsentCookie()) || JSON.parse(JSON.stringify(i));
        for (n in o)
            if (e[n] = o[n],
            !o[n])
                for (var t in r)
                    r[t] === n && (window.GOVUK.cookie(t, null),
                    window.GOVUK.cookie(t) && (document.cookie = t + "=;expires=" + new Date + ";domain=" + window.location.hostname.replace(/^www\./, ".") + ";path=/"));
    ...
    window.GOVUK.checkConsentCookieCategory = function(o, n) {
        if (!window.GOVUK.getConsentCookie() && r[o])
            return !0;
    ...
    window.GOVUK.setCookie = function(o, n, e) {
        window.GOVUK.checkConsentCookie(o, n) && (o = o + "=" + n + "; path=/; SameSite=Lax",
        (e = void 0 === e ? {} : e).days && ((n = new Date).setTime(n.getTime() + 24 * e.days * 60 * 60 * 1e3),
        o = o + "; expires=" + n.toGMTString()),
    ...
    window.GOVUK.getCookie = function(o) {
        for (var n = o + "=", e = document.cookie.split(";"), t = 0, i = e.length; t < i; t++) {
            for (var r = e[t]; " " === r.charAt(0); )
                r = r.substring(1, r.length);
            if (0 === r.indexOf(n))
                return decodeURIComponent(r.substring(n.length))
        }
        return null
    }
}(window);
...
!function(n) {
    ...
    function e(e) {
        n.ga("create", {
            ...
            cookieExpires: 24 * e.expires * 60 * 60,
    ...
    e.prototype.trackEvent = function(e, t, o) {
        ...
        (o = o || {}).label && (e.eventLabel = o.label,
        delete o.label),
        "object" === _typeof(o) && $.extend(e, o),
        n.ga("send", "event", e)
    }
    ,
    n.GOVUK.Analytics = e
...
!function(a) {
    ...
    a.GOVUK.initAnalytics = function() {
        "analytics"in a.GOVUK || (a["ga-disable-".concat(n)] = !1,
        a.GOVUK.Analytics.load(),
        a.GOVUK.analytics = new GOVUK.Analytics({
            trackingId: n,
            cookieDomain: "auto",
            anonymizeIp: !0,
            allowAdFeatures: !1,
...
function(e) {
    ...
    o.clearOldCookies = function(e) {
        var o = ["_ga", "_gid"];
        if (window.GOVUK.cookie("seen_cookie_message") && (document.cookie = "seen_cookie_message=;expires=" + (new Date).toGMTString() + ";path=/"),
        null === e)
            for (var i, t = 0; t < o.length; t++)
                window.GOVUK.cookie(o[t]) && (i = o[t] + "=;expires=" + (new Date).toGMTString() + ";domain=" + window.location.hostname.replace(/^www\./, ".") + ";path=/",
                document.cookie = i)
    }
    ,
    ...
    o.prototype.setupCookieMessage = function() {
        ...
        this.$acceptCookiesLink && this.$acceptCookiesLink.addEventListener("click", function() {
            return e.$module.setCookieConsent(!0)
        }),
        this.$rejectCookiesLink = this.$module.querySelector("button[data-accept-cookies=false]"),
        this.$rejectCookiesLink && this.$rejectCookiesLink.addEventListener("click", function() {
    ...
    o.prototype.showCookieMessage = function() {
        var e;
        this.isInCookiesPage() || (e = window.GOVUK.cookie("cookies_policy"),
        this.$module && !e && (this.$module.style.display = "block"))
    }
    ,
    o.prototype.hideCookieMessage = function(e) {
        this.$module && (this.$module.style.display = "none"),
    ...
    o.prototype.setCookieConsent = function(e) {
        ...
        this.$module.showConfirmationMessage(e),
        this.$module.cookieBannerConfirmationMessage.focus(),
        e && window.GOVUK.initAnalytics()
    }
    ,
...
function(e) {
    ...
    n.prototype.submitSettingsForm = function(e) {
        ...
        return window.GOVUK.setConsentCookie(o),
        this.showConfirmationMessage(),
        window.GOVUK.hasConsentFor("analytics") && window.GOVUK.initAnalytics(),
        !1
    }
    ,
    n.prototype.showConfirmationMessage = function() {
        ...
        o && o !== document.location.pathname ? (t.href = o,
...
!function(l) {
    function s(t, e, i) {
        ...
        0 === s.length && (s = o.parent()).addClass("sticky-scroll-area"),
        this._els = [t],
        this.edge = e,
        this.selector = i,
        this.node = s.get(0),
    ...
    var c = l.jQuery
      , e = l.GOVUK || {}
      , n = "default"
      , a = (s.prototype.addEl = function(t) {
        this._els.push(t)
    }
    ,
    ...
    s.prototype.setEvents = function() {
        this.node.addEventListener("focus", this.focusHandler.bind(this), !0),
        c(this.node).on("keyup", "textarea", this.focusHandler.bind(this))
    }
    ,
    s.prototype.removeEvents = function() {
        this.node.removeEventListener("focus", this.focusHandler.bind(this)),
        c(this.node).find("textarea").off("keyup", "textarea", this.focusHandler.bind(this))
    }
    ,
    s.prototype.getFocusedDetails = {
        forElement: function(t) {
            ...
            return t.bottom = t.top + t.height,
            t
        },
        forCaret: function(t) {
            var e = t.get(0)
    ...
    s.prototype.scrollToRevealElement = function(t) {
        var e, i = t.get(0).nodeName.toLowerCase(), o = r.endOfFurthestEl(this._els, this.edge), s = function() {
            return 0 < t.closest(this.selector).length
        }
        .bind(this);
        if ("textarea" === i)
            e = this.getFocusedDetails.forCaret(t);
        else {
            if (s())
                return;
    ...
    ,
    {
        ...
        getAreaForEl: function(t) {
            for (var e = this._scrollAreas.length; e--; )
                if (this._scrollAreas[e].hasEl(t))
                    return this._scrollAreas[e];
            return !1
        },
        getAreaByEl: function(e) {
            return c.grep(this._scrollAreas, function(t) {
        ...
        syncEls: function(n) {
            ...
            c.each(r, function(t, e) {
                i._scrollAreas[e].destroy(),
                i._scrollAreas.splice(e, 1)
            })
        }
    })
      , r = {
        ...
        endOfFurthestEl: function(t, e) {
            ...
            ;
            return !!t.length && c.map(t, function(t) {
                return i(t)
            }).reduce(function(t, e) {
                return t < e ? e : t
            })
      ...
      , u = (h.prototype._getShimCSS = function() {
        return {
    ...
    h.prototype.release = function(t) {
        this._appliedClass = null,
        this.removeStickyClasses(t),
        this._hasBeenCalled = !0
    }
    ,
    h.prototype.addShim = function(t) {
        this._$shim = c('<div class="shim">&nbsp</div>'),
        this._$shim.css(this._getShimCSS()),
        this.$fixedEl[t](this._$shim)
    }
    ,
    h.prototype.removeShim = function() {
        null !== this._$shim && (this._$shim.remove(),
        this._$shim = null)
    }
    ,
    ...
    ,
    {
        ...
        getOffsetFromEdge: function(t, e) {
            ...
            return "top" === e.edge && i.reverse(),
            (e = i.indexOf(t)) === i.length - 1 ? 0 : (i = i.slice(e + 1),
            this._getTotalHeight(i) - this.spaceBetweenStickys)
        },
        getOffsetFromEnd: function(t, e) {
            var i = this._elsThatCanBeStuck(e._els).slice();
            return "bottom" === e.edge && i.reverse(),
            (e = i.indexOf(t)) === i.length - 1 ? 0 : (i = i.slice(e + 1),
            this._getTotalHeight(i) - this.spaceBetweenStickys)
        },
        ...
        adjustForResize: function(t) {
            ...
            "top" === t.edge ? c(window).scrollTop(this.getInPageEdgePosition(t)) : c(window).scrollTop(this.getInPageEdgePosition(t) - e),
            this.hasResized = !1
        },
      ...
      , i = (t.prototype.setMode = function(t) {
        n = t
    }
    ,
    ...
    t.prototype.setElementPositions = function() {
        ...
        c.each(i._els, function(t, e) {
            e.canBeStuck() && (e = e,
            !i.viewportIsWideEnough(o.width) || i.windowNotPastScrolledFrom(s, i.getScrolledFrom(e)) ? i.reset(e) : i.windowNotPastScrollingTo(s, i.getScrollingTo(e)) ? (i.stick(e),
            e.isStopped() && i.unstop(e)) : (e.isStuck() || i.stick(e),
            i.stop(e)))
        }),
        d.mark(i),
    ...
    t.prototype.setElementDimensions = function(t, e) {
        ...
        this.setElHeight(t, function() {
            t._$shim && t.updateShim(),
            void 0 !== e && e()
        })
    }
    ,
    t.prototype.reset = function(t) {
        t.isStopped() && this.unstop(t),
        t.isStuck() && this.release(t)
    }
    ,
    t.prototype.recalculate = function() {
        ...
        this.syncWithDOM(function() {
            a.syncEls(t._els),
            t.setEvents(),
            "dialog" === n && (u.fitToHeight(t),
            u.hasResized && u.adjustForResize(t)),
            t.setElementPositions()
        })
    }
    ,
    ...
    t.prototype.setElHeight = function(t, e) {
        function i() {
            ...
            t._$shim ? t.inPageEdgePosition = s.getInPageEdgePosition(t._$shim) : t.inPageEdgePosition = s.getInPageEdgePosition(n),
            e()
        }
        var o, s = this, n = t.$fixedEl, r = n.find("img");
        !t.hasLoaded() && 0 < r.length ? ((o = new l.Image).onload = function() {
            i()
        }
        ,
        o.src = r.attr("src")) : i()
    ...
    t.prototype.add = function(t, e, i) {
        var o = this
          ...
          , t = function() {
            n.hasLoaded(!0),
            r || o._els.push(n),
            e && o.setElementPositions(),
            void 0 !== i && i()
        };
        r || (n = new h(s,o),
        a.addEl(n, o.edge, o.CSS_SELECTOR)),
        o.setElementDimensions(n, t)
    }
    ,
    t.prototype.remove = function(e) {
        -1 !== c.inArray(e, this._els) && (this.reset(e),
    ...
    t.prototype.syncWithDOM = function(t) {
        var i = this
          ...
          , o = e.length
          , s = function() {
            i._els.length === o && (i.endOfScrollArea = i.getEndOfScrollArea(),
            void 0 !== t && t())
        };
        this._els.length && c.each(this._els, function(t, e) {
            e.isInPage() || i.remove(e)
        }),
        o && (this._initialPositionsSet = !1,
        e.each(function(t, e) {
            i.add(e, !1, s)
        }))
    }
    ...
    t.prototype.setEvents = function() {
        ...
        !1 === this._scrollTimeout && (c(l).scroll(this._scrollEvent),
        this._scrollTimeout = l.setInterval(this.checkScroll.bind(this), 50)),
        !1 === this._resizeTimeout && (c(l).resize(this._resizeEvent),
        this._resizeTimeout = l.setInterval(this.checkResize.bind(this), 50))
    }
    ,
    t.prototype.clearEvents = function() {
        !1 !== this._scrollTimeout && (c(l).off("scroll", this._scrollEvent),
        l.clearInterval(this._scrollTimeout),
        this._scrollTimeout = !1),
        !1 !== this._resizeTimeout && (c(l).off("resize", this._resizeEvent),
        l.clearInterval(this._resizeTimeout),
        this._resizeTimeout = !1)
    }
    ,
    ...
    t.prototype.checkScroll = function() {
        !0 === this._hasScrolled && (this._hasScrolled = !1,
    ...
    t.prototype.checkResize = function() {
        ...
        !0 === i._windowHasResized && (i._windowHasResized = !1,
        c.each(i._els, function(t, e) {
            i.viewportIsWideEnough(o) ? i.setElementDimensions(e) : i.reset(e)
        }),
        i.viewportIsWideEnough(o) && ("dialog" === n && (u.fitToHeight(i),
        u.hasResized && u.adjustForResize(i)),
        i.setElementPositions()))
    }
    ,
    t.prototype.release = function(t) {
        var e;
        t.isStuck() && (e = t.$fixedEl,
        t.removeStickyClasses(this),
        e.css("width", ""),
        u.releaseEl(t, this),
        t.removeShim(),
        t.release(this))
    ...
    i.getScrollingTo = function(t) {
        t = t.height;
        return "dialog" === n && (t = u.getHeight(this._els)),
        this.endOfScrollArea - t
    }
    ,
    i.getStoppingPosition = function(t) {
        var e = 0;
        return "dialog" === n && (e = u.getOffsetFromEnd(t, this)),
        this.endOfScrollArea - e - t.height
    }
    ,
    ...
    i.stick = function(t) {
        ...
        t.isStuck() || (e = t.$fixedEl,
        i = 0,
        "dialog" === n && (i = u.getOffsetFromEdge(t, this)),
        t.addShim("before"),
        e.css({
            width: e.width() + "px",
            top: i + "px"
    ...
    i.unstop = function(t) {
        var e = 0;
        "dialog" === n && (e = u.getOffsetFromEdge(t, this)),
        t.$fixedEl.css({
            position: "",
            top: e + "px"
        }),
...
"use strict";
!function(o) {
    document.queryCommandSupported("copy") && (o.CopyToClipboard = function() {
        var c = function(o) {
        ...
        this.start = function(o) {
            ...
            e !== a.thing && (a.name = e,
            a.valueLabel = !0),
            t.addClass("copy-to-clipboard").css("min-height", t.height()).html(c($.extend({
                onload: !0
            }, a))).on("click", ".copy-to-clipboard__button--copy", function() {
...
!function(t) {
    var i;
    "oninput"in document.createElement("input") && (i = /\(\(([^\)\((\?)]+)(\?\?)?([^\)\(]*)\)\)/g,
    t.EnhancedTextbox = function() {
        ...
        this.start = function(t) {
            ...
            t = this.$textbox.clone().appendTo("body").css({
                position: "absolute",
                visibility: "hidden",
                display: "block"
            }),
        ...
        this.resize = function() {
            t.$background.width(t.$textbox.width()),
            t.$textbox.height(Math.max(t.initialHeight, t.$background.outerHeight())),
            "stickAtBottomWhenScrolling"in GOVUK && GOVUK.stickAtBottomWhenScrolling.recalculate()
        }
        ,
        ...
        this.update = function() {
            t.$background.html(t.highlightPlaceholders ? t.contentReplaced() : t.contentEscaped()),
            t.resize()
        }
    }
    )
...
window.GOVUK.NotifyModules.FileUpload = function() {
    ...
    this.addCancelButton = function() {
        ...
        $("button.file-upload-button", n.$form).replaceWith(t),
        new window.GOVUK.Frontend.Button(n.$form[0]).init(),
        t.focus()
    }
    ,
...
!function(e) {
    function r(e, o) {
        "default" === e && $("[type=radio]", o).eq(0).focus(),
        "option" === e && $("[type=radio]", o).eq(1).focus()
    }
    ...
    o.RadioSelect = function() {
        this.start = function(n) {
            ...
            function t(e) {
                (e = e.target.parentNode) === c && (e = $("input", e).attr("value"),
                o(e),
                c = null,
            ...
            var i = $(n)
              ...
              , s = $("label", i).toArray().map(function(e) {
                e = $(e);
                return {
                    id: e.attr("for"),
                    label: $.trim(e.text()),
                    value: e.prev("input").attr("value")
                }
            })
              , e = i.data("categories").split(",")
              , u = i.find("input").eq(0).attr("name")
              , c = null
              , d = "true" === i.data("show-now-as-default").toString() && {
                name: u
            };
            i.on("click", ".radio-select__button--category", function(e) {
                e.preventDefault();
...
!function(a) {
    ...
    var l = {}
      ...
      , c = 0
      , f = (s.prototype.addClassName = function(t) {
    ...
    s.prototype.replace = function() {
        ...
        for (var e in this._classesTo$ElsMap)
            this._classesTo$ElsMap[e].each(t);
        this._classesTo$ElsMap = {}
    }
    ,
    function(t, s, a, e) {
        var n = arguments
          , o = Date.now();
        "hidden" !== document.visibilityState && 1 === a.push(t) && $.ajax(s, {
            method: e ? "post" : "get",
            data: e ? $("#" + e).serialize() : {}
        }).done(function(t) {
            for (var s = a, e = t; s.length; )
                s.shift()(e);
            1 === t.stop && (f = function() {}
            ),
            c = i(Date.now() - o)
    ...
    a.GOVUK.NotifyModules.UpdateContent = function() {
        this.start = function(t) {
            var t = $(t)
              ...
              , r = new s(n);
            t.replaceWith(n),
            void 0 !== n.data("classesToPersist") && n.data("classesToPersist").split(" ").forEach(function(t) {
...
!function(t) {
    ...
    i.prototype.getSharedAttributes = function() {
        var i, n, t = this.$wrapper.find("input"), a = Hogan.compile(' {{name}}="{{value}}"'), s = ["id", "name", "value"], r = [], e = function(t) {
            for (var e, i, n = "", s = t.length, r = []; s--; )
                for (i = (e = t[s]).length; i--; )
                    -1 === $.inArray(e[i].name, r) && (n += a.render({
                        name: e[i].name,
                        value: e[i].value
                    }),
                    r.push(e[i].name));
        ...
        t.each(function(t, e) {
            for (i = e.attributes.length,
            n = []; i--; )
                -1 === $.inArray(e.attributes[i].name, s) && n.push({
                    name: e.attributes[i].name,
                    value: e.attributes[i].value
                });
            n.length && r.push(n)
        }),
    ...
    i.prototype.getValues = function() {
        this.entries = [],
        this.$wrapper.find("input").each(function(t, e) {
            e = $(e).val();
            this.entries.push(e)
        }
        .bind(this))
    ...
    i.prototype.trimEntries = function() {
        for (var t = this.entries.length, e = []; t--; )
            "" !== this.entries[t] ? e.push(this.entries[t]) : t < this.minEntries && e.push("");
    ...
    i.prototype.bindEvents = function() {
        this.$wrapper.on("click", ".input-list__button--remove", function(t) {
            this.removeEntry($(t.target))
        }
        .bind(this)),
        this.$wrapper.on("click", ".input-list__button--add", function(t) {
            this.addEntry()
        }
        .bind(this))
    }
    ...
    i.prototype.shiftFocus = function(t) {
        ...
        this.$wrapper.find(".list-entry").eq(t - 1).find("input").focus()
    }
    ,
    i.prototype.removeEntryFromEntries = function(t) {
        for (var e = [], i = 0, n = this.entries.length; i < n; i++)
            t - 1 !== i && e.push(this.entries[i]);
        this.entries = e
    }
    ,
    ...
    i.prototype.render = function() {
        ...
        $.each(this.entries, function(t, e) {
            var i = t + 1
              , t = {
                id: this.getId(i),
                number: i,
            ...
            1 < i && (t.button = !0),
            this.$wrapper.append(this.entryTemplate.render(t))
        }
        .bind(this)),
        this.entries.length < this.maxEntries && this.$wrapper.append(this.addButtonTemplate.render({
            listItemName: this.listItemName,
...
!function(t) {
    ...
    t.LiveSearch = function() {
        this.start = function(t) {
            var a, r, n, s, t = $(t), e = $("input", t), i = $("label", t), o = $(".live-search__status", t), i = (a = e,
            r = i,
            n = o,
            s = $(t.data("targets")),
            function() {
                ...
                s.each(function() {
                    var t = $(".live-search-relevant", this).text() || $(this).text()
                      , t = -1 < l(t).indexOf(l(e));
                    return $(this).has(":checked").length ? ($(this).show(),
                    void i++) : "" == e ? ($(this).css("display", ""),
                    void i++) : ($(this).toggle(t),
                    void (t && i++))
                }),
                "loaded" === u ? ("" !== e && a.attr("aria-label", r.text().trim() + ", " + c(i)),
                u = "active") : (a.removeAttr("aria-label"),
                n.text(c(i))),
                "stickAtBottomWhenScrolling"in GOVUK && GOVUK.stickAtBottomWhenScrolling.recalculate()
            }
            );
...
!function(t) {
    t.GOVUK.NotifyModules.TrackError = function() {
        this.start = function(r) {
            "analytics"in t.GOVUK && t.GOVUK.analytics.trackEvent("Error", $(r).data("error-type"), {
                label: $(r).data("error-label")
            })
        }
    }
}(window);
...
!function() {
    ...
    $("form").on("submit", function(t) {
        ...
        "true" == i.data("clicked") ? t.preventDefault() : (i.data("clicked", "true"),
        setTimeout(e(i), 1500))
    })
}();
"use strict";
window.GOVUK.NotifyModules.FullscreenTable = function() {
    ...
    this.insertShims = function() {
        var e = t.$table.find("caption").text().toLowerCase().replace(/[^A-Za-z]+/g, "");
        ...
        t.$component.append(t.$component.find(".fullscreen-scrollable-table").clone().addClass("fullscreen-fixed-table").removeClass("fullscreen-scrollable-table").removeAttr("role aria-labelledby tabindex").attr("aria-hidden", !0).find("caption").removeAttr("id").closest(".fullscreen-fixed-table")).append('<div class="fullscreen-right-shadow" />').after($("<div class='fullscreen-shim'/>").css({
    ...
    this.maintainHeight = function() {
        ...
        t.$scrollableTable.outerHeight(e),
        t.$fixedTable.outerHeight(e)
    }
    ,
    this.maintainWidth = function() {
        var e = t.$fixedTable.find(".table-field-index").outerWidth();
        t.$scrollableTable.css({
            width: t.$component.parent("main").width() - e,
            "margin-left": e
        }),
        t.$fixedTable.width(e + 4)
    }
    ,
...
window.GOVUK.NotifyModules.RadiosWithImages = function() {
    ...
    this.start = function(e) {
        e = e.get(0);
        e.addEventListener("click", this.handleImageClick),
...
"use strict";
!function(n) {
    var e, t, a, i = ($ = n.jQuery)('.govuk-radios__item input[name="branding_style"]:checked');
    function r() {
    ...
    $("fieldset").on("change", 'input[name="branding_style"]', function(n) {
        "branding_style" == (n = $(n.target)).attr("name") && (i = n.val()),
        a.attr("src", "/_".concat(t, "?").concat(r(["branding_style", i])))
    }))
}(window);
"use strict";
!function(t) {
    t.ColourPreview = function() {
        ...
        this.start = function(t) {
            i.$input = $(t),
            i.$input.parent().append(i.$preview = $('<span class="textbox-colour-preview"></span>')),
            i.$input.on("input", i.update).trigger("input")
        }
        ,
        this.update = function() {
...
window.GOVUK.NotifyModules.TemplateFolderForm = function() {
    ...
    this.start = function(t) {
        ...
        void 0 === this._lastState ? this.selectActionButtons() : (this.currentState = this._lastState,
        this.render()),
    ...
    this.addDescriptionsToStates = function() {
        var n, o;
        $.each(this.states.filter(function(t) {
            return "description"in t
        }), function(t, e) {
            n = "".concat(e.key, "__description"),
            o = '<p class="govuk-visually-hidden" id="'.concat(n, '">').concat(e.description, "</p>"),
            e.$el.prepend(o).attr("aria-describedby", n)
        })
    }
    ,
    this.activateStickyElements = function() {
        ...
        this.states.forEach(function(t) {
            t.$el.find("." + e).removeClass(e).addClass("js-stick-at-bottom-when-scrolling")
        })
    }
    ,
    this.addCancelButton = function(t) {
        var e = this
          ...
          , o = this.makeButton("Cancel", {
            onclick: function() {
                t.$el.find("input:radio").prop("checked", !1),
                t.$el.find("input:text").val(""),
                e.selectActionButtons(n)
            },
            cancelSelector: n,
    ...
    this.addClearButton = function(t) {
        var e = this
          , n = this.makeButton("Clear", {
            onclick: function() {
                e.$form.find("input:checkbox").prop("checked", !1),
                e.selectActionButtons("button[value=add-new-template]")
            },
    ...
    this.makeButton = function(t, e) {
        t = $('<a href=""></a>').html(t).addClass("govuk-link govuk-link--no-visited-state js-cancel").data("target", e.cancelSelector || void 0).attr("tabindex", "0").on("click keydown", function(t) {
            -1 < [13, 32, void 0].indexOf(t.keyCode) && (t.preventDefault(),
            e.hasOwnProperty("onclick") && e.onclick())
        });
        return e.hasOwnProperty("nonvisualText") && t.append('<span class="govuk-visually-hidden"> '.concat(e.nonvisualText, "</span>")),
        t
    }
    ,
    ...
    this.stateChanged = function() {
        ...
        return this._lastState = this.currentState,
        t
    }
    ,
    ...
    this.actionButtonClicked = function(t) {
        ...
        "add-new-template" === t.currentTarget.value && this.$singleNotificationChannel ? window.location = "/services/" + this.$singleChannelService + "/templates/add-" + this.$singleNotificationChannel : this.stateChanged() && this.render()
    }
    ,
    this.selectionStatus = {
        ...
        selected: function(e) {
            ...
            var n = [];
            return 0 < e.templates && n.push(t("templates")),
            0 < e.folders && n.push(t("folders")),
            n.join(", ") + " selected"
        },
        update: function(t) {
            t = 0 < t.total ? e.selectionStatus.selected(t) : e.selectionStatus.default;
            $(".checkbox-list-selected-counter__count").html(t),
            e.$liveRegionCounter.html(t)
        }
    },
    this.templateFolderCheckboxChanged = function() {
        var t = this.countSelectedCheckboxes();
        "nothing-selected-buttons" === this.currentState && 0 !== t.total ? this.currentState = "items-selected-buttons" : "items-selected-buttons" === this.currentState && 0 === t.total && (this.currentState = "nothing-selected-buttons"),
    ...
    this.render = function() {
        ...
        n && "setFocus"in n && (t = $(window).scrollTop(),
        n.setFocus(),
        $(window).scrollTop(t))
    }
    ,
...
window.GOVUK.NotifyModules.AddBrandingOptionsForm = function() {
    ...
    this.start = function(t) {
        ...
        this._lastState = this.$form.data("prev-state"),
        void 0 === this._lastState ? this.showInitialState() : (this.currentState = this._lastState,
        this.render()),
        this.$form.on("change", "input[type=checkbox]", function() {
    ...
    this.addClearButton = function(t) {
        var e = this
          , n = this.makeButton("Clear", {
            onclick: function() {
                e.$form.find("input:checkbox").prop("checked", !1),
                e.$form.find("input:checkbox").eq(0).focus(),
                e.showInitialState()
            },
            nonvisualText: "selection"
        });
    ...
    ,
    this.makeButton = function(t, e) {
        t = $('<a href=""></a>').html(t).addClass("govuk-link govuk-link--no-visited-state js-cancel").attr("tabindex", "0").on("click keydown", function(t) {
            -1 < [13, 32, void 0].indexOf(t.keyCode) && (t.preventDefault(),
            e.hasOwnProperty("onclick") && e.onclick())
        });
        return e.hasOwnProperty("nonvisualText") && t.append('<span class="govuk-visually-hidden"> '.concat(e.nonvisualText, "</span>")),
    ...
    this.selectionStatus = {
        ...
        selected: function(t) {
            var e, n = [];
            return 0 < t.options && n.push(0 === t[e = "options"] ? "" : 1 === t[e] ? "1 ".concat(e.substring(0, e.length - 1)) : "".concat(t[e], " ").concat(e)),
            n.join(", ") + " selected"
        },
        update: function(t) {
    ...
    this.countSelectedCheckboxes = function() {
        return {
            options: this.$form.find("input:checkbox:checked").length
        }
    }
    ,
    this.render = function() {
...
!function() {
    ...
    function i(t) {
        this.module = t,
        this.$el = t.$formGroup.find(".selection-summary").first(),
        this.fieldLabel = t.fieldLabel,
        this.total = t.total,
        this.addContent(),
        this.update(t.getSelection())
    }
    function o(t) {
        this.module = t,
        this.fieldLabel = t.fieldLabel,
        this.fieldsetId = t.$fieldset.attr("id"),
    ...
    i.prototype.addContent = function() {
        ...
        "folder" === this.fieldLabel && this.$text.addClass("selection-summary__text--folders"),
        this.$el.attr("id", t.attr("id")),
    ...
    t.prototype.addHeadingHideLegend = function() {
        ...
        this.$heading = $("<h".concat(t, ' class="heading-small">').concat(this.legendText, "</h").concat(t, ">")),
    ...
    t.prototype.expand = function(t) {
        ...
        this.expanded || (this.$fieldset.show(),
        this.expanded = !0,
    ...
    t.prototype.collapse = function(t) {
        void 0 !== t && t.preventDefault(),
        this.expanded && (this.$fieldset.hide(),
        this.expanded = !1,
        this.summary.update(this.getSelection()),
        this.footer.update(this.expanded)),
    ...
    r.GOVUK.NotifyModules.RegisterSecurityKey = function() {
        this.start = function(n) {
            $(n).on("click", function(t) {
                ...
                fetch("/webauthn/register").then(function(t) {
                    if (t.ok)
                    ...
                    fetch("/webauthn/register", {
                        ...
                        body: r.CBOR.encode({
                            attestationObject: new Uint8Array(t.attestationObject),
                            clientDataJSON: new Uint8Array(t.clientDataJSON)
                        })
                    });
                    var e
                }).then(function(t) {
                    ...
                    console.error(t),
                    r.GOVUK.ErrorBanner.showBanner()
                })
            })
        }
    }
    ...
    a.GOVUK.NotifyModules.AuthenticateSecurityKey = function() {
        this.start = function(r) {
            $(r).on("click", function(e) {
                ...
                fetch("/webauthn/authenticate").then(function(e) {
                    if (e.ok)
                    ...
                    return t && n.searchParams.set("next", t),
                    fetch(n, {
                        method: "POST",
                        headers: {
                            "X-CSRFToken": r.data("csrfToken")
                        },
                        body: a.CBOR.encode({
                    ...
                    console.error(e),
                    a.GOVUK.ErrorBanner.showBanner()
                })
            })
        }
    }
...
window.GOVUK.NotifyModules.UpdateStatus = function() {
    var u = this;
    this.start = function(t) {
        var e, o, n, i, r, a = "update-status";
        u.$component = $(t),
        u.$textbox = $("#" + u.$component.data("target")),
        u.$component.attr("id", a),
        u.$textbox.attr("aria-describedby", (u.$textbox.attr("aria-describedby") || "") + (u.$textbox.attr("aria-describedby") ? " " : "") + a).on("input", (e = u.update,
        r = i = !(o = 150),
        function() {
            var t = arguments
              , a = this;
    ...
    this.update = function() {
        var a;
        $.ajax(u.$component.data("updates-url"), {
            method: "post",
            data: u.$textbox.parents("form").serialize()
        }).done((a = u.$component,
        function(t) {
...
var consentData = window.GOVUK.getConsentCookie()
  , showHideContent = (window.GOVUK.NotifyModules.CookieBanner.clearOldCookies(consentData),
...
$(".js-mark-focus-on-parent").on("focus blur", "*", function(n) {
    $target = $(n.target),
    "focusin" === n.type ? $target.parent().addClass("js-child-has-focus") : $target.parent().removeClass("js-child-has-focus")
});
